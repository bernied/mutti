...
struct arg_t args;
static char CARDS_A_LO_8[] = { 'A', '7', '8', '9', '0', 'J', 'Q', 'K' };
static char CARDS_A_HI_8[] = { '7', '8', '9', '0', 'J', 'Q', 'K', 'A' };
...
// a 7 8 9 0 j q k
void
convert_card_permutation(char* p, bool hi)
{
  char* q = p;
  do
  {
    switch(*q)
    {
      ...
      default:
        printf("%c\n", *q);
        error("Invalid mutti permutation: must be A, 7, 8, 9, 0, J, Q or K!");
    }
  } while(*q++);
}
